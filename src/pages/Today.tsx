...
const UX_VARIANT: string = "ux-stable-kanban";
const UX_TITLE = "Stable Kanban Board";
const UX_SHORT = "Phase-based kanban board that organizes horses by training stage instead of a normal list.";
