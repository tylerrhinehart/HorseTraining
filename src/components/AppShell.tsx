...
const UX_VARIANT = {
  title: "Session First Kiosk",
  short: "Barn-kiosk workflow that prioritizes choosing a horse and starting today’s session before browsing.",
  className: "ux-session-kiosk",
  nav: "kiosk",
};
