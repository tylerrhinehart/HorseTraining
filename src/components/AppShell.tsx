...
const UX_VARIANT = {
  title: "Mobile Coach Companion",
  short: "Phone-first coaching feed with swipe-like horse cards, sticky thumb actions, and story-style hierarchy.",
  className: "ux-mobile-coach",
  nav: "mobile",
};
