...
const UX_VARIANT: string = "ux-mobile-coach";
const UX_TITLE = "Mobile Coach Companion";
const UX_SHORT = "Phone-first coaching feed with swipe-like horse cards, sticky thumb actions, and story-style hierarchy.";
