...
const UX_VARIANT: string = "ux-session-kiosk";
const UX_TITLE = "Session First Kiosk";
const UX_SHORT = "Barn-kiosk workflow that prioritizes choosing a horse and starting today’s session before browsing.";
